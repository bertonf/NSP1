...
QT_MOC_LITERAL(3, 25, 9)
    ...
    "Capture\0AddPacketToList\0\0MyPacket*\0"
};
...
void Capture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->AddPacketToList((*reinterpret_cast< MyPacket*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Capture::*_t)(MyPacket * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Capture::AddPacketToList)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Capture::AddPacketToList(MyPacket * _t1)
{
